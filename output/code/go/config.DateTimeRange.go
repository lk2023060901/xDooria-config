...
type ConfigDateTimeRange struct {
    StartTime int64
    EndTime int64
}

const TypeId_ConfigDateTimeRange = 862172310

func (*ConfigDateTimeRange) GetTypeId() int32 {
    return 862172310
}

func NewConfigDateTimeRange(_buf map[string]interface{}) (_v *ConfigDateTimeRange, err error) {
    _v = &ConfigDateTimeRange{}
