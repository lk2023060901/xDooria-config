...
type ConfigTimeOfDay struct {
    Hour int32
    Minute int32
    Second int32
}

const TypeId_ConfigTimeOfDay = -1260823636

func (*ConfigTimeOfDay) GetTypeId() int32 {
    return -1260823636
}

func NewConfigTimeOfDay(_buf map[string]interface{}) (_v *ConfigTimeOfDay, err error) {
    _v = &ConfigTimeOfDay{}
